export default class SoundEffects {
    ...
    playMainAudio() {
        ...
        this._mainTheme.addEventListener('ended', () => {
            this._mainTheme.currentTime = 0;
            this._mainTheme.play();
        }, false);
    }
    ...
    playPlayerStep() {
        ...
        this._playerStep.volume = 0.4;
    }

    playBorderCollision() {
        this._borderCollision.play();
        this._borderCollision.volume = 0.5;
    }

    playGameOver() {
        this._playerDeath.play();
        this._playerDeath.volume = 0.2;
        this._gameOver.play();
        this._gameOver.volume = 0.2;
    }
    ...
    playTeleport() {
        ...
        this._batTeleportation.volume = 0.2;
    }
}